...
* curl --request GET http://localhost:8084/agentverify/?username=user1&password=password1
...
* **URL**
  ...
  _/agentverify/?username=user1&password=password1_
...
* **Sample Call:**
  ...
  http://localhost:8083/agentverify/?username=user1&password=password1
